	...
	SilicaFlickable {
		...
		Column {
			...
			Button {
				...
				onClicked: {
					pageStack.push(dialogComponent, {confirmationRole: 4})
				}
			...
			Button {
				...
				onClicked: {
					pageStack.push(dialogComponent, {confirmationRole: 5})
				}
			...
			Button {
				...
				onClicked: {
					pageStack.push(dialogComponent, {confirmationRole: 0})
				}
			...
			Button {
				...
				onClicked: {
					pageStack.push(dialogComponent, {confirmationRole: 1})
				}
				enabled: dbStatistic.getArtistQueueSize() === 0 && dbStatistic.getAlbumQueueSize() === 0
			}
			Button {
				...
				onClicked: {
					pageStack.push(dialogComponent, {confirmationRole: 2})
				}
			}
			Button {
				id: clearDBBtn
				...
				onClicked: {
					pageStack.push(dialogComponent, {confirmationRole: 3})
				}
				enabled: dbStatistic.getArtistQueueSize() === 0 && dbStatistic.getAlbumQueueSize() === 0
			}
		}
